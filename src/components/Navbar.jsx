...
const Navbar = () => {
    ...
    return (
        <motion.header
            ...
            className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 ${isScrolled ? 'py-4 bg-[#0a0a0a]/80 backdrop-blur-lg border-b border-white/10' : 'py-6 bg-transparent'
                }`}
        >
