...
const ProjectCard = ({ title, description, tags, link, github, features, delay }) => (
    ...
    >
        <TiltCard className="glass-card group p-8 flex flex-col h-full hover:border-white/30 hover:bg-[var(--card-bg-hover)] hover:shadow-2xl hover:shadow-white/10 transition-all duration-300 overflow-hidden">

            <div className="flex flex-col flex-grow">
                <div className="flex justify-between items-start mb-6">
                    <h3 className="text-2xl font-bold text-white group-hover:text-neutral-300 transition-colors" style={{ transform: 'translateZ(20px)' }}>{title}</h3>
            ...
            <div className="container px-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    <div>
                        ...
                        >
                            <span className="text-xs font-semibold text-neutral-300 tracking-wider uppercase">Portfolio</span>
                        </motion.div>
                        <motion.h2
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
